...
qplot(Sepal.Length, Sepal.Width, data = iris, color = Species) # Miss classification
...
##Slice: use the median value (or the mean value) and see what is going to happen
